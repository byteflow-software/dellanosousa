    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-xs">
              Defesa criminal estratégica com atuação especializada em provas
            ...
            <div className="flex items-center gap-4 mt-6">
              {[
                {
                  href: "https://instagram.com/dellanosousaadvocacia",
                  label: "Instagram",
                ...
                {
                  href: "https://facebook.com/dellanosousa",
                  label: "Facebook",
                ...
                {
                  href: "https://linkedin.com/in/dellanosousa",
                  label: "LinkedIn",
          ...
          <div>
            ...
            <p className="text-white/40 text-xs mt-6">
              Fortaleza · Teresina · Brasília · Ribeirão Preto
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 text-white/40 text-xs">
          <p>© {year} Dellano Sousa Advocacia. Todos os direitos reservados.</p>
